...
namespace SuperfonMobileAPI.Controllers
{
    ...
    public class PowerBIController : ControllerBase
    {
        ...
        public PowerBIController(IConfiguration configuration, SuperfonWorksContext _context, TigerDataService _tigerData)
        {
        ...
        {
            var data = await tigerData.Get_VCReport1530Query(month, branchId, interval, orderby, null);
        ...
        [HttpGet("VCReportByCustomersFiltration/{month:int}/{branchId:int}/{interval}/{customerName}")]
        public async Task<ActionResult<dynamic>> Get_VCReport1530Filtration(int month, int branchId, bool interval, [FromQuery] string orderby, string customerName)
        {
            var data = await tigerData.Get_VCReport1530Query(month, branchId, interval, orderby, customerName);
