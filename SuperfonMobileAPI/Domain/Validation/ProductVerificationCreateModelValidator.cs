...
{
    public partial class ProductVerificationCreateModelValidator
        : AbstractValidator<ProductVerificationCreateModel>
    {
        public ProductVerificationCreateModelValidator()
        {
