...
{
    public partial class SalaryAdvanceRequestViewUpdateModelValidator
        : AbstractValidator<SalaryAdvanceRequestViewUpdateModel>
    {
        public SalaryAdvanceRequestViewUpdateModelValidator()
        {
