...
{
    public partial class SafeAmountTransferViewCreateModelValidator
        : AbstractValidator<SafeAmountTransferViewCreateModel>
    {
        public SafeAmountTransferViewCreateModelValidator()
        {
